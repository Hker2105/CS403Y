            ...
            <div class="col-lg-9">
                <nav class="navbar navbar-expand-lg bg-light navbar-light py-3 py-lg-0 px-0">
                    <a href="" class="text-decoration-none d-block d-lg-none">
                        <h1 class="m-0 display-5 font-weight-semi-bold"><span class="text-primary font-weight-bold border px-3 mr-1">G5</span>Shop</h1>
                    </a>
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto py-0">
                            <b><a href="home.php" class="nav-item nav-link active" style="color: black">Trang chủ</a></b>
                            <b><a href="sanpham.php" class="nav-item nav-link">Sản phẩm</a></b>
                            <b><a href="listcart.php" class="nav-item nav-link">Giỏ hàng</a></b>
                            <div class="nav-item dropdown">
                                <b><a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">Tài khoản</a></b>
                            ...
                            <b><a href="dsdonhang.php" class="nav-item nav-link">Quản lý lịch sử đơn hàng</a></b>
                        </div>
